...
function App() {
  ...
  return (
    <div className='App'>
      <div className='card'>
        <h1 className='text-6xl m-4 font-semi-bold'>GEMINI

        </h1>
        <p className='text-lg'>Enter a prompt and let AI craft unique content for you.
        
        </p>
        <form className='App-form flex items-center w-[88%] mt-2 p-2 mx-auto' onSubmit={submitHandler}>
          ...
          <input 
            ...
            className='border p-2 rounded-md w-[95%]'
          />
        ...
        <section className='' >
          ...
          {mutation.isPending && (
            <div className='flex items-start w-[85%] mx-auto'>
